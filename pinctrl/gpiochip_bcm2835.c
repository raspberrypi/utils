...
{
    { "I2C0_SDA"  , "SA5"        , "PCLK"      , "AVEOUT_VCLK"   , "AVEIN_VCLK" , 0           , },
    { "I2C0_SCL"  , "SA4"        , "DE"        , "AVEOUT_DSYNC"  , "AVEIN_DSYNC", 0           , },
    { "I2C1_SDA"  , "SA3"        , "LCD_VSYNC" , "AVEOUT_VSYNC"  , "AVEIN_VSYNC", 0           , },
    { "I2C1_SCL"  , "SA2"        , "LCD_HSYNC" , "AVEOUT_HSYNC"  , "AVEIN_HSYNC", 0           , },
    ...
    { "UART0_TXD" , "SD6"        , "DPI_D10"   , "AVEOUT_VID10"  , "AVEIN_VID10", "UART1_TXD" , },
    { "UART0_RXD" , "SD7"        , "DPI_D11"   , "AVEOUT_VID11"  , "AVEIN_VID11", "UART1_RXD" , },
    { "FL0"       , "SD8"        , "DPI_D12"   , "UART0_CTS"     , "SPI1_CE2_N" , "UART1_CTS" , },
    { "FL1"       , "SD9"        , "DPI_D13"   , "UART0_RTS"     , "SPI1_CE1_N" , "UART1_RTS" , },
    ...
    { "I2C0_SDA"  , "SA5"        , "PCM_CLK"   , "FL0"           , 0            , 0           , },
    { "I2C0_SCL"  , "SA4"        , "PCM_FS"    , "FL1"           , 0            , 0           , },
    { "TE0"       , "SA3"        , "PCM_DIN"   , "UART0_CTS"     , 0            , "UART1_CTS" , },
    { "FL0"       , "SA2"        , "PCM_DOUT"  , "UART0_RTS"     , 0            , "UART1_RTS" , },
    { "GPCLK0"    , "SA1"        , "RING_OCLK" , "UART0_TXD"     , 0            , "UART1_TXD" , },
    { "FL1"       , "SA0"        , "TE1"       , "UART0_RXD"     , 0            , "UART1_RXD" , },
    { "GPCLK0"    , "SOE_N_SE"   , "TE2"       , "SD1_CLK"       , 0            , 0           , },
    { "SPI0_CE1_N", "SWE_N_SRW_N", 0           , "SD1_CMD"       , 0            , 0           , },
    { "SPI0_CE0_N", "SD0"        , "UART0_TXD" , "SD1_DAT0"      , 0            , 0           , },
    { "SPI0_MISO" , "SD1"        , "UART0_RXD" , "SD1_DAT1"      , 0            , 0           , },
    { "SPI0_MOSI" , "SD2"        , "UART0_RTS" , "SD1_DAT2"      , 0            , 0           , },
    { "SPI0_SCLK" , "SD3"        , "UART0_CTS" , "SD1_DAT3"      , 0            , 0           , },
    { "PWM0"      , "SD4"        , 0           , "SD1_DAT4"      , "SPI2_MISO"  , "UART1_TXD" , },
    { "PWM1"      , "SD5"        , "TE0"       , "SD1_DAT5"      , "SPI2_MOSI"  , "UART1_RXD" , },
    { "GPCLK1"    , "SD6"        , "TE1"       , "SD1_DAT6"      , "SPI2_SCLK"  , "UART1_RTS" , },
    { "GPCLK2"    , "SD7"        , "TE2"       , "SD1_DAT7"      , "SPI2_CE0_N" , "UART1_CTS" , },
    { "GPCLK1"    , "I2C0_SDA"   , "I2C1_SDA"  , "TE0"           , "SPI2_CE1_N" , 0           , },
    { "PWM1"      , "I2C0_SCL"   , "I2C1_SCL"  , "TE1"           , "SPI2_CE2_N" , 0           , },
    { "I2C0_SDA"  , "I2C1_SDA"   , "SPI0_CE0_N", 0               , 0            , "SPI2_CE1_N", },
    { "I2C0_SCL"  , "I2C1_SCL"   , "SPI0_MISO" , 0               , 0            , "SPI2_CE0_N", },
...
{
    { "I2C0_SDA"  , "SA5"        , "PCLK"      , "SPI3_CE0_N"    , "UART2_TXD"       , "I2C6_SDA"    , },
    { "I2C0_SCL"  , "SA4"        , "DE"        , "SPI3_MISO"     , "UART2_RXD"       , "I2C6_SCL"    , },
    { "I2C1_SDA"  , "SA3"        , "LCD_VSYNC" , "SPI3_MOSI"     , "UART2_CTS"       , "I2C3_SDA"    , },
    { "I2C1_SCL"  , "SA2"        , "LCD_HSYNC" , "SPI3_SCLK"     , "UART2_RTS"       , "I2C3_SCL"    , },
    { "GPCLK0"    , "SA1"        , "DPI_D0"    , "SPI4_CE0_N"    , "UART3_TXD"       , "I2C3_SDA"    , },
    { "GPCLK1"    , "SA0"        , "DPI_D1"    , "SPI4_MISO"     , "UART3_RXD"       , "I2C3_SCL"    , },
    { "GPCLK2"    , "SOE_N_SE"   , "DPI_D2"    , "SPI4_MOSI"     , "UART3_CTS"       , "I2C4_SDA"    , },
    { "SPI0_CE1_N", "SWE_N_SRW_N", "DPI_D3"    , "SPI4_SCLK"     , "UART3_RTS"       , "I2C4_SCL"    , },
    { "SPI0_CE0_N", "SD0"        , "DPI_D4"    , "I2CSL_CE_N"    , "UART4_TXD"       , "I2C4_SDA"    , },
    { "SPI0_MISO" , "SD1"        , "DPI_D5"    , "I2CSL_SDI_MISO", "UART4_RXD"       , "I2C4_SCL"    , },
    { "SPI0_MOSI" , "SD2"        , "DPI_D6"    , "I2CSL_SDA_MOSI", "UART4_CTS"       , "I2C5_SDA"    , },
    { "SPI0_SCLK" , "SD3"        , "DPI_D7"    , "I2CSL_SCL_SCLK", "UART4_RTS"       , "I2C5_SCL"    , },
    { "PWM0_0"    , "SD4"        , "DPI_D8"    , "SPI5_CE0_N"    , "UART5_TXD"       , "I2C5_SDA"    , },
    { "PWM0_1"    , "SD5"        , "DPI_D9"    , "SPI5_MISO"     , "UART5_RXD"       , "I2C5_SCL"    , },
    { "UART0_TXD" , "SD6"        , "DPI_D10"   , "SPI5_MOSI"     , "UART5_CTS"       , "UART1_TXD"   , },
    { "UART0_RXD" , "SD7"        , "DPI_D11"   , "SPI5_SCLK"     , "UART5_RTS"       , "UART1_RXD"   , },
    { 0           , "SD8"        , "DPI_D12"   , "UART0_CTS"     , "SPI1_CE2_N"      , "UART1_CTS"   , },
    { 0           , "SD9"        , "DPI_D13"   , "UART0_RTS"     , "SPI1_CE1_N"      , "UART1_RTS"   , },
    ...
    { "SD0_CLK"   , "SD14"       , "DPI_D18"   , "SD1_CLK"       , "ARM_TRST"        , "I2C6_SDA"    , },
    { "SD0_CMD"   , "SD15"       , "DPI_D19"   , "SD1_CMD"       , "ARM_RTCK"        , "I2C6_SCL"    , },
    ...
    { "I2C0_SDA"  , "SA5"        , "PCM_CLK"   , 0               , "MII_A_RX_ERR"    , "RGMII_MDIO"  , },
    { "I2C0_SCL"  , "SA4"        , "PCM_FS"    , 0               , "MII_A_TX_ERR"    , "RGMII_MDC"   , },
    { 0           , "SA3"        , "PCM_DIN"   , "UART0_CTS"     , "MII_A_CRS"       , "UART1_CTS"   , },
    { 0           , "SA2"        , "PCM_DOUT"  , "UART0_RTS"     , "MII_A_COL"       , "UART1_RTS"   , },
    { "GPCLK0"    , "SA1"        , 0           , "UART0_TXD"     , "SD_CARD_PRES"    , "UART1_TXD"   , },
    { 0           , "SA0"        , 0           , "UART0_RXD"     , "SD_CARD_WRPROT"  , "UART1_RXD"   , },
    { "GPCLK0"    , "SOE_N_SE"   , 0           , "SD1_CLK"       , "SD_CARD_LED"     , "RGMII_IRQ"   , },
    { "SPI0_CE1_N", "SWE_N_SRW_N", 0           , "SD1_CMD"       , "RGMII_START_STOP", 0             , },
    { "SPI0_CE0_N", "SD0"        , "UART0_TXD" , "SD1_DAT0"      , "RGMII_RX_OK"     , "MII_A_RX_ERR", },
    { "SPI0_MISO" , "SD1"        , "UART0_RXD" , "SD1_DAT1"      , "RGMII_MDIO"      , "MII_A_TX_ERR", },
    { "SPI0_MOSI" , "SD2"        , "UART0_RTS" , "SD1_DAT2"      , "RGMII_MDC"       , "MII_A_CRS"   , },
    { "SPI0_SCLK" , "SD3"        , "UART0_CTS" , "SD1_DAT3"      , "RGMII_IRQ"       , "MII_A_COL"   , },
    { "PWM1_0"    , "SD4"        , 0           , "SD1_DAT4"      , "SPI0_MISO"       , "UART1_TXD"   , },
    { "PWM1_1"    , "SD5"        , 0           , "SD1_DAT5"      , "SPI0_MOSI"       , "UART1_RXD"   , },
    { "GPCLK1"    , "SD6"        , 0           , "SD1_DAT6"      , "SPI0_SCLK"       , "UART1_RTS"   , },
    { "GPCLK2"    , "SD7"        , 0           , "SD1_DAT7"      , "SPI0_CE0_N"      , "UART1_CTS"   , },
    { "GPCLK1"    , "I2C0_SDA"   , "I2C1_SDA"  , 0               , "SPI0_CE1_N"      , "SD_CARD_VOLT", },
    { "PWM0_1"    , "I2C0_SCL"   , "I2C1_SCL"  , 0               , "SPI0_CE2_N"      , "SD_CARD_PWR0", },
    { "I2C0_SDA"  , "I2C1_SDA"   , "SPI0_CE0_N", 0               , 0                 , "SPI2_CE1_N"  , },
    { "I2C0_SCL"  , "I2C1_SCL"   , "SPI0_MISO" , 0               , 0                 , "SPI2_CE0_N"  , },
